...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/Brassaroto/blogpessoal_spring) dentro da pasta do *Workspace* do STS
...
Desenvolvido por [**Gustavo**](https://github.com/Brassaroto)
